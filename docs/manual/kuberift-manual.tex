...
\subsubsection{Describe — \texttt{Enter}}
...
\subsubsection{Logs — \texttt{Ctrl-L}}
...
\subsubsection{Exec — \texttt{Ctrl-E} (single item)}
...
\subsubsection{Delete — \texttt{Ctrl-D}}
...
\subsubsection{Port-Forward — \texttt{Ctrl-F} (single item)}
...
\subsubsection{Rollout Restart — \texttt{Ctrl-R}}
...
\subsubsection{Print YAML — \texttt{Ctrl-Y}}
